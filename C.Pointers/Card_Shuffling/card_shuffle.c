...
/**
 * @brief Deal cards in deck
 *    @param wDeck Deck array
 *    @param wFace Face array
 *    @param wSuit Suit array
 */
void deal(unsigned int wDeck[SUITS][FACES], const char* wFace[], const char* wSuit[])
{
   ...
   for (size_t card = 1; card <= CARDS; ++card)
   {
      ...
      {
         // loops through columns of wDeck for current row
