;14.5 - 6 - Text matching program (another modification)
...
;Unfortunately this program doesn't allow to prompt user to enter the file's name	
...
;keyboard struct for string to find
...
string_name_msg db "Please enter string to find: $"
fail_msg db "ERROR! $"
...
;write number of line, on which the string appears
