...
inc si
loop L1
sub si, lengthof string; delimit string found in text
dec si
mov al, "@"
mov [si], al
add si, lengthof string
inc si
mov al, "&"
mov [si], al	
...
comment @
; write line number on which string appears
