...
inline void MM_CollectionVersionAnnounce::clear_collectionversion() {
  collectionversion_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
inline void MM_CollectionVersionAnnounce::_internal_set_collectionversion(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  collectionversion_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void MM_CollectionVersionAnnounce::set_collectionversion(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  collectionversion_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void MM_CollectionVersionAnnounce::set_collectionversion(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  collectionversion_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
...
inline std::string* MM_CollectionVersionAnnounce::_internal_mutable_collectionversion() {
  _has_bits_[0] |= 0x00000001u;
  return collectionversion_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
