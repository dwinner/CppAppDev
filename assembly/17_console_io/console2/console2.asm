...
push  rbp 
mov   rbp, rsp
   mov   rdi, msg1          ; print 1st string 
   call  prints
   mov   rdi, msg2          ; print 2nd string, no NL 
   call  prints
   mov   rdi, input         ; address of input buffer
   mov   rsi, inputlen      ; length of input buffer 
   call  reads              ; wait for input 
   mov   rdi, msg3          ; print 3rd string and add the input string
   call  prints
...
mov   rbp, rsp
   ...
   mov   r12, rdi       ; address of string buffer
...
.done:
   inc   r12
   mov   byte [r12], 0      ; add end 0 to string buffer
