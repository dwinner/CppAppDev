...
; RDI-      Points at character set variable
...
; Skip to the starting offset in the source string (-1 because
; this code increments RSI immediately below).

            lea     rsi, [rsi][rax-1] ;RAX=starting offset
