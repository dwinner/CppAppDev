...
; Returns:
;
; RAX-      Index of first character in cset.
;           0 if first char in cset, string length
;           if no chars in cset.
;
; CF=0	If successful operation.
; CF=1	If starting offset is out of range.
;
; Defaults to skipToCharPS if the character set string
; is longer than 64 characters.
;
; This code is almost identical to skipChars2. A few
; JNZ instructions have been changed to JZ instructions
; and a JMP skipCharsPS was changed to JMP skipToCharPS.
...
skp2JmpTbl  qword   csetEmpty, useXmm2, useXmm23
