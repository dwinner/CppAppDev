...
#define __HTTPDOWNLOADDER_H__

#ifndef CHTTPDOWNLOADDER_EXT_CLASS
#define CHTTPDOWNLOADDER_EXT_CLASS
#endif //#ifndef CHTTPDOWNLOADDER_EXT_CLASS
...
class CHTTPDOWNLOADDER_EXT_CLASS CHTTPDownloader
{
public:
//Constructors / Destructors
  CHTTPDownloader();
  CHTTPDownloader(const CHTTPDownloader&) = delete;
  CHTTPDownloader(CHTTPDownloader&&) = delete;
  virtual ~CHTTPDownloader();

//Methods
  CHTTPDownloader& operator=(const CHTTPDownloader&) = delete;
  CHTTPDownloader& operator=(CHTTPDownloader&&) = delete;
  bool Download();
...
//Member variables
  ...
  bool m_bIgnoreCertificateRevocationProblems; //Set to true to set the SECURITY_FLAG_IGNORE_REVOCATION flag
  bool m_bIgnoreUnknownCertificateAuthorityProblems; //Set to true to set the SECURITY_FLAG_IGNORE_UNKNOWN_CA flag
  bool m_bIgnoreIncorrectUsageProblems; //Set to true to set the SECURITY_FLAG_IGNORE_WRONG_USAGE flag
  ...
  bool m_bIgnoreHTTPSToHTTPRedirectErrors; //Set to true to set the SECURITY_FLAG_IGNORE_REDIRECT_TO_HTTP flag
  bool m_bIgnoreHTTPToHTTPSRedirectErrors; //Set to true to set the SECURITY_FLAG_IGNORE_REDIRECT_TO_HTTPS flag
...
//Static methods
  static void CALLBACK _OnWininetStatusCallBack(_In_ HINTERNET hInternet, _In_ DWORD_PTR dwContext, _In_ DWORD dwInternetStatus, _In_opt_ LPVOID lpvStatusInformation, _In_ DWORD dwStatusInformationLength);
...
//Virtual methods
  ...
  virtual bool DoHTTPAuthentication();
  virtual bool DoProxyAuthentication();
  virtual bool DoCertificateSelection();
  virtual void OnWininetStatusCallBack(_In_ HINTERNET hInternet, _In_ DWORD dwInternetStatus, _In_opt_ LPVOID lpvStatusInformation, _In_ DWORD dwStatusInformationLength);
