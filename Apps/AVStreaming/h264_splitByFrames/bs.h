...
#ifndef H264_SPLITBYFRAMES_BS_H
#define H264_SPLITBYFRAMES_BS_H
...
{
   return (int) ((b->p > b->end ? b->end : b->p) - b->start);
}

static inline int bs_bytes_left(bs_t *b)
{
