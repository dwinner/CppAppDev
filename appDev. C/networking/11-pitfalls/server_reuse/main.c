 ...
 * You will see that the bind() calling is ok,
 * due to socket reusing is on.
 */
...
int main()
{
   ...
   int reuseAddr = 1;
   if (setsockopt(socketListen, SOL_SOCKET, SO_REUSEADDR, (void *) &reuseAddr, sizeof(reuseAddr)) < 0)
   {
