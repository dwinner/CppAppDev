...
//               va_list argptr );
// int vsnprintf( char * restrict buffer, size_t n, const char * restrict format,
//                va_list argptr );
...
void write_log(const char *function_name, unsigned int line_num, const char *format_str, ...)
{
   if (fp_log == NULL)
   {
      return;
